// set basic variabels
var rowNumber = 0, counter = 0, userName = document.getElementById('getName'), userCity = document.getElementById('getCity'), userCountry = document.getElementById('getCountry'), userAge = document.getElementById('getAge'), submitBtn = document.getElementById('submit');
var list = [];
// table = document.getElementsByClassName('InformationTable'),
// Event Click 
submitBtn.addEventListener('click', function () {
    var name = userName.value, city = userCity.value, country = userCountry.value, age = userAge.value;
    rowNumber++;
    counter++;
    // build tr and td for add to table 
    var table = document.createElement('table', ''), trOfTable = document.createElement('tr', ''), rowInTable = document.createElement('td'), nameInTable = document.createElement('td'), cityInTable = document.createElement('td'), countryInTable = document.createElement('td'), ageInTable = document.createElement('td'), editInTable = document.createElement('td'), deleteInTable = document.createElement('td');
    ...
    deleteRow.appendChild(deleteValue);
    // srt style for tr and td
    ...
    deleteInTable.style.paddingRight = '60px';
    ...
    deleteInTable.innerHTML = deleteRow.value;
    //append td in tr and tr in table
    ...
    editRow.addEventListener('click', function (e) {
        var userName = document.getElementById('getName'), userCity = document.getElementById('getCity'), userCountry = document.getElementById('getCountry'), userAge = document.getElementById('getAge');
        var eParent = e.parentNode.parentNode;
        var trOfTable = document.createElement('tr', ''), nameInTable = document.createElement('td'), cityInTable = document.createElement('td'), countryInTable = document.createElement('td'), ageInTable = document.createElement('td');
